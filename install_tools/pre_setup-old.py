...
Type=Application
Terminal=false
Exec=gnome-terminal -e 'bash -c "python ''' + os.path.join(self.general['fortrace-path'],  "guest_tools/guestAgent.py") + '''; bash"'
Hidden=false
...
''')
    ...
    def windows_autostart(self):
        ...
        try:
            ...
            prepCmd = "schtasks /create /sc ONLOGON /tn fortrace /RL HIGHEST /tr %HOMEPATH%\Desktop\fortrace\guest_tools\startGuestAgent.bat /f"
            subprocess.call(prepCmd.split(), stdout=subprocess.PIPE)
