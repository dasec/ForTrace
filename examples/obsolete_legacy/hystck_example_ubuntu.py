...
def create_vm(logger):
    ...
    guest = virtual_machine_monitor1.create_guest(guest_name="l-guest01", platform="linux")
...
def gen_email_traffic(guest, logger):
    ...
    mailerobj.set_config("Linux guest", "fortrace007@gmail.com", "f!8Uq6b7hKMJX9vz", "fortrace007@gmail.com",
...
def gen_browser_traffic(guest, logger):
    ...
    for line in f:
        ...
        if browser_opened is False:
            ...
            browser_obj = guest.application("webBrowser", {'webBrowser': "firefox"})
