...
vm_name = "cleanUp{0}".format(random.randint(0, 9999))
...
sc.addUser("Alice", "123")
sc.addUser("Bob","123")
wait(10)
sc.changeUser("Alice", "123")
sc.reboot()
sc.changeUser("Bob", "123")
sc.reboot()
sc.deleteUser("Fred", "keep")

####### Finishing scenario #######
# shut down system to end scenario
# when using manual cleanup
