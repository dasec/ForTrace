...
#              Helper Functions             #
#############################################
# Do not make changes in this functions!
...
sc.addUser("User1", "jyrL-Lvfah")
sc.changeUser("User1", "jyrL-Lvfah")
# reboot to new user
...
sc.addUser("User2", "123")
sc.addUser("User3", "123")
sc.writeTextFile("Hello", r"C:\Test.txt")
sc.changeUser("User3", "123")
sc.reboot("2021-07-15 18:00:00")
sc.browserOpen("heise.de")
wait(10, 20)
sc.browserBrowseTo("www.youtube.com")
wait(10, 20)
sc.browserClose()
sc.deleteUser("User1", "keep")
wait(10, 11)
