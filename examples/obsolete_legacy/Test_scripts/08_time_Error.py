...
vm_name = "Scenario{0}_CleanUp".format(random.randint(0, 9999))
...
wait()
sc.reboot("2020-05-10 10:52:12")
wait()
sc.reboot("2021-05-15 10:52:12")
ntp_servers = "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\DateTime\Servers"
sc.deleteRegistryKey(ntp_servers)
wait()
sc.reboot("2020-02-10 11:52:12")
wait()
sc.reboot("2021-06-30 12:00:00")
wait()
sc.reboot("2021-01-01 12:00:00")
wait()
