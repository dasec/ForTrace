...
# provoke error on Reg deletion:
src = r"C:\Users\fortrace\Desktop\fortrace\docs_old\pictures\cpu.png"
dst = r"C:\Users\fortrace\Desktop\cpu.png"
dst2 = r"C:\Users\fortrace\Desktop\cpu2.png"
sc.move(src, dst)
sc.copy(dst, dst2)
sc.recycle(dst2)
wait(40,80)
sc.emptyRecycleBin()
wait(40, 120)
sc.disableRecycleBin()
wait()
sc.reboot()
sc.recycle(r"C:\Users\fortrace\Desktop\fortrace\docs_old\pictures\harddisk.png")
wait()
sc.secureDelete(r"C:\Users\fortrace\Desktop\fortrace\docs_old\pictures\Keywords.txt")
wait(60,180)
# shut down system
sc.shutdown()
# Scenario finished
