...
#Collect EventLog Artifacts
    ...
    #AVOIDING LOGS
        ...
        #Run at the end of sessions
            ...
            #History files
                ...
                if(Test-Path "$($env:USERPROFILE)\AppData\Roaming\Microsoft\Windows\PowerShell\PSReadline\ConsoleHost_history.txt")
    ...
    #DELETING LOGS
        ...
        #Showing the PowerShell logs results in LogEntry with ID 104 in the System logs
