# This is a modified version of the first validation scenario, with cleanup at the beginning and the end of the scenario
...
scenario_start = "2022-08-19 06:32:15"
#############################################
...
# Start as  user and create new user for scenario
####### Session 0 -  #######
sc.addUser("Bill", "jyrL-Lvfah")
sc.changeUser("Bill", "jyrL-Lvfah")
sc.reboot("2022-08-19 10:52:12")

####### Session 1 - Bill #######
# reduce traces to the  user by deleting it first and cleaning the Event Log afterwards
sc.deleteUser("", "secure", "needle")
...
#wait()
sc.smbCopy(hannah_picture1, hannah_picture1_t, smb_share, smb_user, smb_pass, "")
#wait()
sc.smbCopy(hannah_picture2, hannah_picture2_t, smb_share, smb_user, smb_pass, "needle")
...
#wait()
sc.browserBrowseTo("www.impfdashboard.de")
#wait()
sc.browserClose()
#wait()
...
qcow2_path = "/data/-pool/backing/" + vm_name + ".qcow2"
